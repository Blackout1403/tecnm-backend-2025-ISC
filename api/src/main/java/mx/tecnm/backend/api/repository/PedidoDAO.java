...
public List<Pedido> Consultarpedido () {
 ...
 public Pedido ConsultarpedidoPorID (int pedido_id) {
        String sql = "SELECT id, fecha, fecha_hora_pago, importe_envio, importe_iva, importe_productos, metodos_pago_id, numero, total, usuarios_id FROM pedidos WHERE id = ?";
